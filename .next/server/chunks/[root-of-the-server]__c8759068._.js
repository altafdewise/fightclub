module.exports=[18622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},20635,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/action-async-storage.external.js",()=>require("next/dist/server/app-render/action-async-storage.external.js"))},54799,(e,t,r)=>{t.exports=e.x("crypto",()=>require("crypto"))},91279,e=>e.a(async(t,r)=>{try{let t=await e.y("pg-dcf270bf3659e986");e.n(t),r()}catch(e){r(e)}},!0),70406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},93695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},56755,e=>e.a(async(t,r)=>{try{var n=e.i(91279),a=t([n]);[n]=a.then?(await a)():a;let o=process.env.DATABASE_URL;if(!o)throw Error("DATABASE_URL is not set.");let d=new n.Pool({connectionString:o});async function i(e,t=[]){return await d.query(e,t)}async function s(e){let t=await d.connect();try{await t.query("BEGIN");let r=await e(t);return await t.query("COMMIT"),r}catch(e){throw await t.query("ROLLBACK"),e}finally{t.release()}}e.s(["query",()=>i,"transaction",()=>s]),r()}catch(e){r(e)}},!1),80313,e=>e.a(async(t,r)=>{try{var n=e.i(54799),a=e.i(56755),i=t([a]);[a]=i.then?(await i)():i;async function s(e){let t=n.default.randomBytes(32).toString("hex"),r=new Date(Date.now()+6048e5);return await (0,a.query)(`INSERT INTO sessions (session_token, type, admin_id, client_id, expires_at)
     VALUES ($1, $2, $3, $4, $5)`,[t,e.type,e.adminId||null,e.clientId||null,r]),{sessionToken:t,expiresAt:r}}async function o(e){await (0,a.query)("DELETE FROM sessions WHERE session_token = $1",[e])}e.s(["createSession",()=>s,"deleteSession",()=>o]),r()}catch(e){r(e)}},!1),45519,e=>{"use strict";function t(e){return e.toISOString().slice(0,10)}function r(){return t(new Date)}function n(e){let r=[],n=new Date;for(let a=0;a<e;a+=1){let e=new Date(n);e.setUTCDate(n.getUTCDate()-a),r.push(t(e))}return r}e.s(["lastNDaysKeys",()=>n,"toDateKey",()=>t,"todayKey",()=>r])},51073,e=>e.a(async(t,r)=>{try{var n=e.i(56755),a=e.i(84345),i=t([n,a]);async function s(e,t){let r=await (0,n.query)("SELECT id, client_id, trainer_id, created_at FROM conversations WHERE client_id = $1 LIMIT 1",[e]);return r.rows[0]?r.rows[0]:await (0,n.transaction)(async r=>(await r.query(`INSERT INTO conversations (client_id, trainer_id)
       VALUES ($1, $2)
     ...
     RETURNING id, conversation_id, sender_id, sender_role,
       COALESCE(sender_type, sender_role)::text AS sender_type,
       COALESCE(content, message_text) AS content,
       client_id, trainer_id, message_text, image_url, client_temp_id, is_read, read_at, created_at`,[e.conversationId,e.senderId,i,i,e.clientId,e.trainerId??null,a,a,r,e.clientTempId??null])).rows[0]}async function u(e,t){"hq"!==t.type&&await (0,n.query)(`UPDATE messages
     SET is_read = true,
         read_at = COALESCE(read_at, NOW())
     WHERE conversation_id = $1 AND sender_type <> $2 AND is_read = false`,[e,t.type])}async function _(e,t){if("hq"===t.type)return 0;let r=await (0,n.query)(`SELECT COUNT(*)::int AS count
     FROM messages
     ...
     FROM messages m
     JOIN conversations c ON c.id = m.conversation_id
     WHERE c.trainer_id = $1 AND m.sender_type <> 'trainer' AND m.is_read = false`,[e.userId]);return parseInt(t.rows[0]?.count||"0",10)}[n,a]=i.then?(await i)():i,e.s(["assertConversationAccess",()=>d,"ensureConversation",()=>s,"getConversationById",()=>o,"getConversationMetaForClient",()=>y,"getConversationMetaForTrainer",()=>p,"getMessagesForConversation",()=>c,"getTotalUnreadForUser",()=>m,"getUnreadCount",()=>_,"insertMessage",()=>l,"markMessagesRead",()=>u,"resolveChatAccess",()=>E]),r()}catch(e){r(e)}},!1),15061,e=>{"use strict";var t=e.i(30088);async function r(){let e=await (0,t.cookies)(),r=e.get("admin_session");if(r?.value)return{authorized:!0,role:"admin",sessionToken:r.value};let n=e.get("hq_session");return n?.value?{authorized:!0,role:"hq",sessionToken:n.value}:{authorized:!1}}e.s(["requireAdminOrHQ",()=>r])}];

//# sourceMappingURL=%5Broot-of-the-server%5D__c8759068._.js.map